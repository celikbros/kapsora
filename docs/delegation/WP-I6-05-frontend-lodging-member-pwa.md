...
| Read first                 | `DESIGN.md` (all of **Patterns settled while building**, now forty-two entries) and `PRODUCT.md`; WP-I4-06 and WP-I5-06 as delivered and their finish-review notes in docs/plan/ROADMAP.md (2026-09-05/06); the provider and backoffice surface briefs under `web/apps/*/.impeccable/surfaces/`; the member PWA shell (`web/apps/member/src/App.tsx`) as it stands — login, tenant, a "Yakında" home |
